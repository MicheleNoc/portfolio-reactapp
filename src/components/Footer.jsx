...
<footer class="bg-white dark:bg-black w-full">
    <div class="mx-auto w-full max-w-full p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Michele Nocchi</a>.
            </span>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
    <a href="https://github.com/MicheleNoc" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
    ...
    <a href="https://www.linkedin.com/in/michele-nocchi-287563196/" target="_blank" rel="noopener noreferrer" class="ml-4 text-gray-500 hover:text-gray-900 dark:hover:text-white">
