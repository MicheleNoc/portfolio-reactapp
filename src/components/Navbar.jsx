  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-transparent backdrop-blur-sm"> 
      <div className="mr-5 ml-5 flex items-center justify-between mx-auto p-4">
        ...
        <button
          className="inline-flex items-center fixed-button p-2 ml-3 text-sm text-black dark:text-white rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600" 
        ...
        <div
          className={`w-full md:flex md:items-right md:w-auto ${
