...
<section class="bg-white dark:bg-black h-screen relative">
    ...
    <div class="relative z-10 flex items-center justify-center h-full px-4 py-8">
        <div class="text-center">
            ...
            <p class="max-w-2xl mb-6  text-black dark:text-white lg:mb-8 md:text-lg lg:text-xl dark:text-white-400">
            ...
            <a href="/CV.pdf" download class="text-black font-bold dark:text-white inline-flex items-center justify-center px-5 py-3 text-base text-center rounded-lg bg-primary-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Scarica CV
                <IoMdDownload className="ml-2"/>
            </a>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
        <a href="https://github.com/MicheleNoc" target="_blank" rel="noopener noreferrer" className="text-black dark:text-white hover:text-white dark:hover:text-primary">
        ...
        <a href="https://www.linkedin.com/in/michele-nocchi-287563196/" target="_blank" rel="noopener noreferrer" className="ml-4 text-black dark:text-white hover:text-white dark:hover:text-primary">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19.5 0h-15C2.016 0 0 2.016 0 4.5v15C0 21.984 2.016 24 4.5 24h15c2.484 0 4.5-2.016 4.5-4.5v-15C24 2.016 21.984 0 19.5 0zM7.5 20h-3v-10h3v10zm-1.5-11.5c-.966 0-1.5-.634-1.5-1.5 0-.866.534-1.5 1.5-1.5s1.5.634 1.5 1.5c0 .866-.534 1.5-1.5 1.5zm15 11.5h-3v-5.5c0-1.25-.025-2.875-1.75-2.875-1.75 0-2 1.25-2 2.875v5.5h-3v-10h3v1.375c1.5-2.875 5.5-2.875 5.5 1.125V20z"/></svg>
        </a>
</div>
        </div>
    </div>
